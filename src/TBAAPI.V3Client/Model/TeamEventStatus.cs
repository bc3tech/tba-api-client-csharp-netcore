...
namespace TBAAPI.V3Client.Model
{
    ...
    public partial class TeamEventStatus : IEquatable<TeamEventStatus>, IValidatableObject
    {
        ...
        public TeamEventStatus(TeamEventStatusRank qual = default, TeamEventStatusAlliance alliance = default, TeamEventStatusPlayoff playoff = default, string allianceStatusStr = default, string playoffStatusStr = default, string overallStatusStr = default, string nextMatchKey = default, string lastMatchKey = default)
        {
            this.Qual = qual;
