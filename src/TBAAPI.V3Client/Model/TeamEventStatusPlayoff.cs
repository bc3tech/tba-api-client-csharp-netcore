...
namespace TBAAPI.V3Client.Model
{
    ...
    public partial class TeamEventStatusPlayoff : IEquatable<TeamEventStatusPlayoff>, IValidatableObject
    {
        ...
        public TeamEventStatusPlayoff(LevelEnum? level = default, WLTRecord currentLevelRecord = default, WLTRecord record = default, StatusEnum? status = default, int playoffAverage = default)
        {
            this.Level = level;
