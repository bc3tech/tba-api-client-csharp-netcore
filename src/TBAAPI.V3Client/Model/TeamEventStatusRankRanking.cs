...
namespace TBAAPI.V3Client.Model
{
    ...
    public partial class TeamEventStatusRankRanking : IEquatable<TeamEventStatusRankRanking>, IValidatableObject
    {
        ...
        public TeamEventStatusRankRanking(int matchesPlayed = default, double qualAverage = default, List<decimal> sortOrders = default, WLTRecord record = default, int rank = default, int dq = default, string teamKey = default)
        {
