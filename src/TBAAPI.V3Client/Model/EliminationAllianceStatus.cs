...
namespace TBAAPI.V3Client.Model
{
    ...
    public partial class EliminationAllianceStatus : IEquatable<EliminationAllianceStatus>, IValidatableObject
    {
        ...
        public EliminationAllianceStatus(double playoffAverage = default, string level = default, WLTRecord record = default, WLTRecord currentLevelRecord = default, string status = default)
        {
