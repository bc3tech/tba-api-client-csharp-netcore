...
namespace TBAAPI.V3Client.Model
{
    ...
    public partial class TeamEventStatusRank : IEquatable<TeamEventStatusRank>, IValidatableObject
    {
        ...
        public TeamEventStatusRank(int numTeams = default, TeamEventStatusRankRanking ranking = default, List<TeamEventStatusRankSortOrderInfo> sortOrderInfo = default, string status = default)
        {
